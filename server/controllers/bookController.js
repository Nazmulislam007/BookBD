...
//       const query = {
//         $or: [
//           { catagories: filteredContent[0].catagories },
//           { subCatagory: filteredContent[0].subCatagory },
//         ],
//       };
//       counterQuery = query;
//       counterLimit = {};
...
//     res.status(200).json({ totalCount, books, filteredContent });
//   } catch (error) {
//     next(error);
//   }
// };
